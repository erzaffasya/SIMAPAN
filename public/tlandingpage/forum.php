...
<section id="header-hero">
    <div class="container">
        ...
        <div class="row align-items-center">
            <div class="col-6">
                <img src="asset/img/empty-img.jpeg" alt="" class="w-100 rounded" height="320px" style="object-fit: cover;">
            </div>
            <div class="col-6">
                <h1 class="fs-2 fw-bold">Struktur Forum Anak Balikpapan</h1>
                <p class="fs-5">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, </p>
            </div>
        </div>
    </div>
</section>
            ...
            <div class="pengurus-slide">
                <div class="mx-2">
                    <figure class="rounded overflow-hidden">
                        <img src="asset/img/empty-img.jpeg" alt="" class="w-100" height="280px" style="object-fit: cover;">
                        <figcaption class="bg-white px-3 py-2 text-center">
                            <p class="fw-bold mb-0">Bapak siapa namanya</p>
                            <p class="text-secondary mb-0">Bapak siapa namanya</p>
                        </figcaption>
                    </figure>
                </div>
                <div class="mx-2">
        ...
        <div class="row">
            <div class="col-7">
                <figure class="position-relative">
                    <img src="asset/img/empty-img.jpeg" alt="" class="w-100 rounded" height="370px">
                    <figcaption class="position-relative h-100 d-flex align-items-end">
                        <div class="px-2 py-3 m-0 w-100">
                            ...
                            <p class="fs-6 mb-0 text-secondary">Lorem ipsum dolor sit amet consectetur adipisicing elit. Molestias voluptates illum obcaecati eaque, perspiciatis doloremque qui non nulla possimus pariatur corrupti aut veritatis et ali</p>
                        </div>
                    </figcaption>
                </figure>
            </div>
                        ...
                        <div class="row g-0">
                            ...
                            <div class="col-md-7">
                                <div class="card-body h-100">
                                    ...
                                    <p class="fs-6 mb-0 text-secondary">Lorem ipsum dolor sit amet consectetur adipisicing elit. Molestii</p>
                                </div>
                            </div>
                        </div>
                    </a>
...
<section id="kegiatan-section">
    <div class="container py-5">
        ...
        <div class="row g-0 gy-0">
            <div class="col-3">
                <img src="asset/img/empty-img.jpeg" class="w-100" alt="">
            </div>
            <div class="col-3">
                <img src="asset/img/empty-img.jpeg" class="w-100" alt="">
            </div>
