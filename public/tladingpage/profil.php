...
<section id="header-hero">
    <div class="container">
        ...
        <div class="row align-items-center justify-content-center">
            <div class="col-5">
                <img src="asset/img/anak.png" alt="" class="w-100">
            </div>
            <div class="col-6">
            ...
            <div class="row">
                <div class="col">
                    <figure class="rounded overflow-hidden h-100 bg-white">
                        <img src="asset/img/kluster-1.png" alt="" class="w-100 px-5 py-4">
                ...
                <div class="col">
                    <figure class="rounded overflow-hidden h-100 bg-white">
                        <img src="asset/img/kluster-2.png" alt="" class="w-100 px-5 py-4">
                        <figcaption class="bg-white px-3 py-2 text-center">
                ...
                <div class="col">
                    <figure class="rounded overflow-hidden h-100 bg-white">
                        <img src="asset/img/kluster-3.png" alt="" class="w-100 px-5 py-4">
                        <figcaption class="bg-white px-3 py-2 text-center">
                ...
                <div class="col">
                    <figure class="rounded overflow-hidden h-100 bg-white">
                        <img src="asset/img/kluster-4.png" alt="" class="w-100 px-5 py-4">
                        <figcaption class="bg-white px-3 py-2 text-center">
                ...
                <div class="col">
                    <figure class="rounded overflow-hidden h-100 bg-white">
                        <img src="asset/img/kluster-5.png" alt="" class="w-100 px-5 py-4">
                        <figcaption class="bg-white px-3 py-2 text-center">
...
<section id="lembaga-section">
    <div class="container py-5">
        <div class="row align-items-center">
            <div class="col-6">
                <img src="asset/img/empty-img.jpeg" class="w-100" height="370px" alt="">
            </div>
            <div class="col-6">
                <h1 class="fs-1 fw-bold mb-3">Kegiatan Kelembagaan</h1>
                <ol class="fs-4 text-secondary lh-2">
                    <li>Perda Nomor 6 Tahun 2020 tentang perubahan Peraturan Daerah Kota Balikpapan Nomor 1 Tahun 2015 tentang Penyelenggaraan Perlindungan Anak</li>
                    <li>Perda Balikpapan Menuju Kota Layak Anak (sedang dalam proses pembuatan di Bagian Hukum)</li>
                    <li>Peraturan Wali Kota tentang Rencana Aksi Daerah sedang dalam proses pembuatan di Bagian Hukum, menunggu penyelesaian Perda Kota Layak Anak</li>
                </ol>
            </div>
        </div>
    </div>
