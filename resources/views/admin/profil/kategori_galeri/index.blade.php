<x-app-layout>
    <div class="content">
        <div class="page-header">
            ...
            <div class="page-btn">
                <a href="{{ route('profil-kategori-galeri.create') }}" class="btn btn-added"><img
            ...
            <div class="card-body">
                ...
                <div class="table-responsive">
                    <table class="table datanew">
                        ...
                        <tbody>
                            @foreach ($profil_kategori_galeri as $item)
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex">
                                            <a class="me-3"
                                                href="{{ route('profil-kategori-galeri.edit', $item->id) }}">
                                                <img src="{{ asset('tadmin/assets/img/icons/edit.svg') }}"
                                                    alt="img">
                                            </a>
                                            <a class='confirm-text' href='javascript:void(0);' data-bs-toggle='modal'
                                                data-bs-target='#deleteModal' data-id='{{ $item->id }}'
                                                data-action='{{ route('profil-kategori-galeri.destroy', $item->id) }}'
