                        ...
                        <tbody>
                            @foreach ($forum_artikel as $item)
                                <tr>
                                    ...
                                    <td>{{ $item->judul }}</td>
                                    <td>{{ $item->kecamatanForumArtikel ? ucwords(strtolower($item->kecamatanForumArtikel->name)) : '-' }}
                                    </td>
                                    <td>{{ $item->kelurahanForumArtikel ? ucwords(strtolower($item->kelurahanForumArtikel->name)) : '-' }}
                                    </td>
                                    <td>{{ $item->foto }}</td>
                                    <td>
                                        <div class="d-flex">
