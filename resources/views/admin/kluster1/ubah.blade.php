    ...
    <div class="content">
        <div class="page-header">
            <div class="page-title">
                <h4>Kluster 1</h4>
                <h6>Ubah Data Kluster 1</h6>
            </div>
        </div>
        <!-- /add -->
        <div class="card">
            <div class="card-body">
                <form method="post" action="{{ route('kluster1.update', $kluster1->id) }}" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="form-group">
                                <label>Judul</label>
                                <input name="judul" value="{{ $kluster1->judul }}" type="text" required>
                            </div>
                        </div>
                                    ...
                                    <div class="card-body">
                                        <div class="custom-file-container" data-upload-id="mySecondImage">
                                            ...
                                            <div class="custom-file-container__image-preview--active"
                                                ...
                                                @foreach ($kluster1->galeri as $gambar)
                        ...
                        <div class="col-lg-12">
                            <div class="form-group">
                                ...
                                <x-forms.tinymce-editor name="deskripsi">{{ $kluster1->deskripsi }}
                        ...
                        <div class="col-lg-12">
                            ...
                            <a href="{{ route('kluster1.index') }}" class="btn btn-cancel">Cancel</a>
                        </div>
                    </div>
                </form>
            </div>
