                ...
                <form method="post" action="{{ route('kegiatan.update', $kegiatan->id) }}" enctype="multipart/form-data">
                    ...
                    <div class="row">
                                ...
                                <select class="form-control" name="kantor_id">
                                    ...
                                    @foreach ($lKantor as $item)
                                        <option value="{{ $item->id }}"
                                            {{ $kegiatan->kantor_id == $item->id ? 'selected' : '' }}>
                                            {{ $item->kantor }}</option>
                                    @endforeach
                                </select>
                            </div>
                        ...
                        <div class="col-lg-12 col-sm-12 col-12">
                            <div class="form-group">
                                <label>Judul</label>
                                <input name="judul" type="text" value="{{ $kegiatan->judul }}" required>
                            </div>
                        </div>
                        <div class="col-lg-12 col-sm-12 col-12">
                            <div class="form-group">
                        ...
                        <div class="col-lg-12">
                            <div class="form-group">
                                <label>Isi</label>
                                <textarea name="isi" class="form-control">{{ $kegiatan->isi }}</textarea>
                            </div>
                        </div>
