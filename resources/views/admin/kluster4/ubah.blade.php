    ...
    <div class="content">
        <div class="page-header">
            <div class="page-title">
                <h4>Kluster 4</h4>
                <h6>Ubah Data Kluster 4</h6>
            </div>
        </div>
        <!-- /add -->
        <div class="card">
            <div class="card-body">
                <form method="post" action="{{ route('kluster4.update', $kluster4->id) }}" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="form-group">
                                <label>Judul</label>
                                <input name="judul" value="{{ $kluster4->judul }}" type="text" required>
                            </div>
                        </div>
                                    ...
                                    <div class="card-body">
                                        <div class="custom-file-container" data-upload-id="mySecondImage">
                                            ...
                                            <div class="custom-file-container__image-preview--active"
                                                ...
                                                @foreach ($kluster4->galeri as $gambar)
                        ...
                        <div class="col-lg-12">
                            <div class="form-group">
                                ...
                                <x-forms.tinymce-editor name="deskripsi">{{ $kluster4->deskripsi }}
                        ...
                        <div class="col-lg-12">
                            ...
                            <a href="{{ route('kluster4.index') }}" class="btn btn-cancel">Cancel</a>
                        </div>
                    </div>
                </form>
            </div>
