<x-app-layout>
    <div class="content">
        <div class="page-header">
            ...
            <div class="page-btn">
                <a href="{{ route('kategori-artikel.create') }}" class="btn btn-added"><img
                        ...
                        <tbody>
                            @foreach ($kategori_artikel as $item)
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex">
                                            <a class="me-3" href="{{ route('kategori-artikel.edit', $item->id) }}">
                                                <img src="{{ asset('tadmin/assets/img/icons/edit.svg') }}"
                                                    alt="img">
                                            </a>
                                            <a class='confirm-text' href='javascript:void(0);' data-bs-toggle='modal'
                                                data-bs-target='#deleteModal' data-id='{{ $item->id }}'
                                                data-action='{{ route('kategori-artikel.destroy', $item->id) }}'
