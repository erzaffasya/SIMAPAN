    ...
    <div class="content">
        <div class="page-header">
            <div class="page-title">
                <h4>Artikel Kluster 3</h4>
                <h6>Manajemen Artikel Kluster 3</h6>
            </div>
        </div>
        <div class="card">
            <div class="card-body">
                ...
                <div class="table-responsive">
                    <table class="table datanew">
                        ...
                        <tbody>
                            @foreach ($kluster3 as $item)
                                <tr>
                                    <td>{{ $loop->iteration }}</td>
                                    <td>{{ $item->judul }}</td>
                                    <td>
                                        <div class="d-flex">
                                            <a class="me-3" href="{{ route('kluster3.edit', $item->id) }}">
                                                <img src="{{ asset('tadmin/assets/img/icons/edit.svg') }}"
                                                    alt="img">
                                            </a>
                                            <a class='confirm-text' href='javascript:void(0);' data-bs-toggle='modal'
                                                data-bs-target='#deleteModal' data-id='{{ $item->id }}'
                                                data-action='{{ route('kluster3.destroy', $item->id) }}'
