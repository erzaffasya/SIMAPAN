    ...
    <div class="content">
        <div class="page-header">
            <div class="page-title">
                <h4>Kluster 3</h4>
                <h6>Ubah Data Kluster 3</h6>
            </div>
        </div>
        <!-- /add -->
        <div class="card">
            <div class="card-body">
                <form method="post" action="{{ route('kluster3.update', $kluster3->id) }}" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="form-group">
                                <label>Judul</label>
                                <input name="judul" value="{{ $kluster3->judul }}" type="text" required>
                            </div>
                        </div>
                                    ...
                                    <div class="card-body">
                                        <div class="custom-file-container" data-upload-id="mySecondImage">
                                            ...
                                            <div class="custom-file-container__image-preview--active"
                                                ...
                                                @foreach ($kluster3->galeri as $gambar)
                        ...
                        <div class="col-lg-12">
                            <div class="form-group">
                                ...
                                <x-forms.tinymce-editor name="deskripsi">{{ $kluster3->deskripsi }}
                        ...
                        <div class="col-lg-12">
                            ...
                            <a href="{{ route('kluster3.index') }}" class="btn btn-cancel">Cancel</a>
                        </div>
                    </div>
                </form>
            </div>
