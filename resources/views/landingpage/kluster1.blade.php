        ...
        <div class="bg-greens bg-img-overlay item1-img pt-4 pb-5 mt-5">
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-10">
                        <h4 class="text-center text-white mb-4 lh-md">UPAYA PERCEPATAN AKTA KELAHIRAN TERUTAMA BAGI ANAK YANG MEMERLUKAN PERLINDUNGAN KHUSUS (AMPK)</h4>
                    </div>
                    <div class="col-3">
                    ...
                    <div class="col-3">
                        <figure class="rounded overflow-hidden h-100 bg-white">
                            ...
                            <figcaption class="bg-white px-3 py-2 text-center">
                                ...
                                <p class="text-secondary mb-0">Layanan online menggunakan aplikasi SIPANTAI BALIKPAPAN </p>
                            </figcaption>
                        </figure>
                    </div>
                    <div class="col-3">
                        <figure class="rounded overflow-hidden h-100 bg-white">
                            ...
                            <figcaption class="bg-white px-3 py-2 text-center">
                                <h5 class="mb-1 text-dark">KERJASAMA</h5>
                                <p class="text-secondary mb-0">Dinas Sosial dan Lembaga Masyarakat seperti Peksos dan PPATBM</p>
                            </figcaption>
                        </figure>
                    </div>
                </div>
        ...
        <div class="container py-5">
            <div class="row align-items-start justify-content-center">
                <div class="col-11 text-center">
                    ...
                    <p class="text-secondary fs-6 lh-lg">Lembaga layanan informasi anak yang terstandarisasi pusat informasi sahabat anak (PISA) di Kota Balikpapan terdapata 1 Lembaga layanan yaitu perpustakaan daerah, yang ditetapkan melalui SK Walikota Balikpapan Nomor : 188.45-445/2022 dan telah terstandarisasi kategori madya oleh kementerian PPA</p>
                </div>
                <div class="col-6">
                ...
                <div class="col-4">
                    ...
                    <ol class="list-group">
                        ...
                        <li class="list-group-item">Pojok baca di perkantoran seperti mal playanan publik, kantor kecamatan, kantor kelurahan</li>
            ...
            <div class="row justify-content-center align-items-end">
                <div class="col-5">
                    ...
                    <ul class="list-group">
                        ...
                        <li class="list-group-item">Kumpul bareng forum anak bersama Himpunan Psikolog Klinis Balikpapan</li>
                        ...
                        <li class="list-group-item">Mengikuti dan menyampaikan aspirasi suara anak dalam Musrenbang tingkat kelurahan, kecamatan, dan kota</li>
                ...
                <div class="row justify-content-center">
                    <div class="col-10">
                        <div class="p-3 text-white text-center">
                            <p class="mb-0 fs-4 fw-bold">Forum anak sudah terbentuk di semua tingkatan yang terdiri dari<br> 1 Forum Anak Kota Balikpapan, 6 Forum Anak Kecamatan dan 34 Forum Anak Kelurahan</p>
                        </div>
                    </div>
                </div>
            </div>
